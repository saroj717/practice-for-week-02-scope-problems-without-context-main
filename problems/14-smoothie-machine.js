...
***********************************************************************/
const smoothieMachine = (...ingredients) => (...extraIngredients) =>
  `I'm having a smoothie with ${[...ingredients, ...extraIngredients].join(" and ")}`;



const smoothieMachine = (...ingredients) => {
  return function(...sentence) {
    let allIngredients = ingredients.concat(sentence);
...
function smoothieMachine(...ingredients) {
  return function(...extraIngredients) {
